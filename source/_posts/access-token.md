...
```
        ...
        StringBuffer buffer = new StringBuffer("grant_type=client_credential");
        buffer.append("&appid="+defaultConfig.getAppid());
        buffer.append("&secret="+defaultConfig.getSecret());
        String result = HttpUtils.sendGet(tokenUrl,buffer.toString());
        JSONObject obj = JSONObject.parseObject(result);
        if(obj.get("errcode") != null){
            throw new BadRequestException("二维码生成异常");
        }
```

### http请求工具类
```
package com.zerocat.core.utils;
